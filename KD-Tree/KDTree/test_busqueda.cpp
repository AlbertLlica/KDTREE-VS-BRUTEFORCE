...
int main() {
    ...
    int q;
    //double x1 = 2.6 ,y1 = 0, z1 = 1.2 , r = 200; 
    //double x1 = 963.00 ,y1 = 32.00, z1 = 773.00  , r = 200;   //modifico aleatorio
    //double x1 = 446.00 ,y1 = 1912.00, z1 = 17137.00  , r = 2000;
    double x1 = 984.00 ,y1 = 694.00, z1 = 573.00  , r = 9000;
    Point ans;
